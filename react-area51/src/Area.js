...
class Area extends React.Component {
	...
	getAreaComponents(){
		...
		if (this.context.content != null) {
			...
			if (cmsAreaName != null) {
				var actualComponents = Object.values(contextService.getAreaComponents(cmsAreaName, relativeContentPath));
	...
	render() {
		...
		if (components){
			componentElements = components.map(component => (
				instantiateReactComponent(component, this.props, this.context.componentMap, false)
			));
		}
